...
You will receive the user's browsing history, including item IDs, item descriptions, and user ratings.
...
Candidate list:
{}
Another recommendation system provided the following recommendation list:
{}
"""
...
class RecAgent:
    ...
    def forward(self,history_lst:str,candidate_lst:str,predicted:str)->int:
